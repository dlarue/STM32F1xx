/*
  laserJL1_map.h - driver code for STM32F103C8 ARM processors
...
#elif N_AXIS == 3
#define BOARD_NAME "Laser JL1 3-axis"
#else
...
#define SPINDLE_ENABLE_PIN      2 // was 1
#define SPINDLE_DIRECTION_PORT  GPIOB
#define SPINDLE_DIRECTION_PIN   1 // was 0
